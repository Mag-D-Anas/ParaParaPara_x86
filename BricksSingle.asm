public DrawBricks_proc_single
public CheckCollision_proc_single
...
extrn BALL_X_single:word
extrn BALL_Y_single:word
extrn BALL_SIZE_single:word
extrn BALL_VELOCITY_X_single:word
extrn BALL_VELOCITY_Y_single:word
  
.CODE

;---------------------------------------
    ; Function: DrawBricks_proc_single
...
DrawBricks_proc_single PROC FAR
   MOV AX, @DATA
   MOV DS, AX
   PUSH BX
   ...
   draw_bricks:
    ...
    CALL DrawBrick_proc_single                ; draw the brick at (SI,DI)
...
DrawBrick_proc_single PROC NEAR
   PUSH CX 
   PUSH DX
   PUSH BX  
   ...
   ; draw a pixel - 10 column, - 10 row, color: red
        ...
        POP CX
RET
DrawBrick_proc_single ENDP

;---------------------------------------
; Function: CheckCollision_proc_single
...
CheckCollision_proc_single PROC FAR
    PUSH BX
    PUSH AX
    PUSH CX
    PUSH DX
    ...
    row_loop:
        ...
        ; check top edge
            MOV AX, BALL_Y_single 
            ADD AX, BALL_SIZE_single           ; calculate the bottom edge of the ball
        ...
        column_loop:
            ...
            ; check left edge
                MOV AX, BALL_X_single 
                ADD AX, BALL_SIZE_single           ; calculate the right edge of the ball
    ...
    exit_collision:
        ...
        POP BX
RET
CheckCollision_proc_single ENDP
